...
Function Start-MultipleMachineDistributionListMigration
{
    ...
    *OPTIONAL*
    ...
    for ($serverCounter = 0 ; $serverCounter -lt $forEnd ; $serverCounter++)
    {
        ...
        {
            out-logfile -string ("Address in contact array: "+$address)
        }
    }
